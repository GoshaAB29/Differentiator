...
//==========================================================================
    ...
    new_node_left_left_right_left->left  = NULL;
    new_node_left_left_right_left->right = NULL;
    ...
    new_node_left_left_right_right->left  = NULL;
    new_node_left_left_right_right->right = NULL;
...
//==========================================================================
    ...
    new_node_left_right->left  = NULL;
    new_node_left_right->right = NULL;
...
//==========================================================================
    ...
    new_node_left_left_left->left  = NULL;
    new_node_left_left_left->right = NULL;
...
struct Pnode* diff_sin(struct Pnode* node)
{
    ...
    new_node_left_left->left  = NULL;
    new_node_left_left->right = NULL;
...
void i_am_simp(struct Pnode* start_node)
{
    ...
    {
        i_am_simp(start_node->left);
        i_am_simp(start_node->right);
    }
...
void graph(struct Pnode* start_node) 
{
    ...
    snprintf(cmd, sizeof(cmd), "dot -Tpng dump.txt -o graph.png");
    system (cmd);
